  ...
  async buildContext(
    ...
    return {
      ...
      pageGuidance: [
        ...
        "Populate filter_context.datePeriod as lowercase mtd|qtd|ytd|lq|lm|ly. Add channelGroup only when relevant. Do NOT reference Leaderboard or add leaderName; insights are scoped to Loan Complexity only.",
      ],
