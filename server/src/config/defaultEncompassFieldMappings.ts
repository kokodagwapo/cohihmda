...
export interface FieldMappingDefinition {
  ...
  alias: string;
  description?: string;
  category?: 'loan' | 'borrower' | 'property' | 'pricing' | 'dates' | 'compliance' | 'fees' | 'team' | 'other';
}
...
export const DEFAULT_ENCOMPASS_FIELD_MAPPINGS: Record<string, string> = {
  ...
  'Total Mortgaged Properties Count': 'Fields.ULDD.TotalMortgagedPropertiesCount',
  ...
  'CoBorrower Mailing Address is same as the Property Address': 'Fields.ULDD.X154',
  ...
  'Freddie AVM Model Name Type Other Description': 'Fields.ULDD.FRE.AVMModelNameExpl',
  ...
  'GFE Initial GFE Disclosure Affiliated Business Disclosure Provided Date': 'Fields.3544',
  ...
  // Milestone Dates
  'Started': 'Fields.Log.MS.Date.Started',
  ...
  'Processing': 'Fields.Log.MS.Date.Processing',
  ...
  'Fee Details - Line 804 - Borrower POC Amount - Appraisal': 'Fields.NEWHUD2.X1101',
  'Fee Details - Line 804 - Seller POC Amount - Appraisal': 'Fields.NEWHUD2.X1104',
  'Fee Details - Line 804 - Broker POC Amount - Appraisal': 'Fields.NEWHUD2.X1107',
  'Fee Details - Line 804 - Lender POC Amount - Appraisal': 'Fields.NEWHUD2.X1110',
  'Fee Details - Line 804 - Other POC Amount - Appraisal': 'Fields.NEWHUD2.X1113',
  ...
  'Fee Details - Line 805 - Borrower POC Amount - Cred Report': 'Fields.NEWHUD2.X1134',
  'Fee Details - Line 805 - Seller POC Amount - Cred Report': 'Fields.NEWHUD2.X1137',
  'Fee Details - Line 805 - Broker POC Amount - Cred Report': 'Fields.NEWHUD2.X1140',
  'Fee Details - Line 805 - Lender POC Amount - Cred Report': 'Fields.NEWHUD2.X1143',
  'Fee Details - Line 805 - Other POC Amount - Cred Report': 'Fields.NEWHUD2.X1146',
  ...
  'Fee Details - Line 807 - Borrower POC Amount - Flood Cert': 'Fields.NEWHUD2.X1200',
  'Fee Details - Line 807 - Seller POC Amount - Flood Cert': 'Fields.NEWHUD2.X1203',
  'Fee Details - Line 807 - Broker POC Amount - Flood Cert': 'Fields.NEWHUD2.X1206',
  'Fee Details - Line 807 - Lender POC Amount - Flood Cert': 'Fields.NEWHUD2.X1209',
  'Fee Details - Line 807 - Other POC Amount - Flood Cert': 'Fields.NEWHUD2.X1212',
};
 ...
 */
export function getAllMappingsAsArray(): Array<{ alias: string; fieldId: string }> {
  return Object.entries(DEFAULT_ENCOMPASS_FIELD_MAPPINGS).map(([alias, fieldId]) => ({
    alias,
    fieldId,
  }));
}
...
console.log(`[DefaultEncompassFieldMappings] Loaded ${getFieldMappingCount()} default field mappings`);
