...
const HmdaData = () => {
  ...
  useEffect(() => {
    // #region agent log
    fetch('http://127.0.0.1:7691/ingest/9e8b316c-fdcc-477d-8f49-0a3f242b8005',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'4a35ed'},body:JSON.stringify({sessionId:'4a35ed',runId:'hmda-run-1',hypothesisId:'H4',location:'cohi/src/pages/HmdaData.tsx:mount',message:'Host HMDA iframe configuration',data:{activeSection,loadedSections:Array.from(loadedSections),searchSrc:iframeSrcBySection.search,lendersSrc:iframeSrcBySection.lenders,productsSrc:iframeSrcBySection.products,geographySrc:iframeSrcBySection.geography,href:window.location.href},timestamp:Date.now()})}).catch(()=>{});
    // #endregion
  }, [activeSection, loadedSections, iframeSrcBySection]);
