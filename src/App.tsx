...
/**
 * Redirects /workbench?canvas=xxx to /my-dashboard?canvas=xxx
 * Fixes the share URL pattern generated by WorkbenchCanvas.
 */
function WorkbenchRedirect() {
  const location = useLocation();
  return <Navigate to={`/my-dashboard${location.search}`} replace />;
}
