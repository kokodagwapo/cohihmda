...
export function getSidebarSearchTargets(): SidebarRouteSearchTarget[] {
  const sectionTargets: SidebarRouteSearchTarget[] = [
    ...
    { id: 'route:leaderboard-dashboard', label: 'Leaderboard', group: 'Dashboards', kind: 'route', path: '/leaderboard', keywords: ['dashboards', 'insights'] },
    { id: 'route:business-overview-dashboard', label: 'Business Overview', group: 'Dashboards', kind: 'route', path: '/business-overview', keywords: ['dashboards', 'insights'] },
  ...
  const toptieringTargets: SidebarRouteSearchTarget[] = [
    ...
    { id: 'route:productionSummaryByWeek', label: 'Production Summary by Week', group: 'TopTiering', kind: 'route', path: '/production-summary-by-week', keywords: ['toptiering', 'top tiering', 'production', 'summary', 'weekly', 'sales'] },
    ...
    { id: 'route:activeWorkload', label: 'Active Workload', group: 'TopTiering', kind: 'route', path: '/performance/active-workload', keywords: ['operations', 'active workload', 'active files', 'days active', 'dashboard'] },
