...
export const DASHBOARD_SECTION_GROUPS: { label: string; items: DashboardSectionItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'salesCompanyOverview', title: 'Sales Company Overview', icon: BarChart3, iconClass: 'text-blue-500' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'productionTrends', title: 'Production Trends', icon: LineChart, iconClass: 'text-indigo-500' },
      { id: 'productionSummaryByWeek', title: 'Production Summary by Week', icon: LineChart, iconClass: 'text-blue-500' },
