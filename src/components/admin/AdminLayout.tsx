...
const allAdminSections: AdminSectionDef[] = [
  ...
  {
    id: "deployment" as AdminSection,
    label: "Deployment",
    icon: Cloud,
    description: "Manage deployment instances",
  ...
  {
    id: "aws-hosting" as AdminSection,
    label: "AWS Hosting",
    icon: Cloud,
    description: "Per-lender AWS hosting and billing",
  ...
  },
  {
    ...
    icon: Shield,
    description: "Feature access and action permissions",
    color: "text-pink-300 dark:text-pink-400/70",
    allowedRoles: ["super_admin", "platform_admin", "tenant_admin"],
    category: "Users & Access",
    mode: "tenant",
  },
