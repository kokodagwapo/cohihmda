...
export function Footer() {
  ...
  // Only show footer on dashboard and landing page
  if (!isDashboard && !isLandingPage) {
    return null;
  }

  return (
    <footer className="w-full bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl border-t border-slate-200/30 dark:border-slate-800/30">
