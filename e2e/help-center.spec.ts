...
test.describe("Help Center", () => {
  test("@COHI-398 @smoke help home and learning paths load", async ({ userPage }) => {
  ...
  test("@COHI-398 @critical category and article navigation works with breadcrumbs", async ({ userPage }) => {
    await userPage.goto("/help", { waitUntil: "domcontentloaded" });
